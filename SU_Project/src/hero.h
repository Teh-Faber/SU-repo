...
public:
    ...
    Hero(QString name): Character(name, 10, 2, 0), level(1), id(0), gold(0){} // new hero

    Hero(QString name, int hp, int strength, int xp, int level, int id, int gold): Character(name, hp, strength, xp), level(level), id(id), gold(gold){} // load hero
